      ...
      <div class="container container-tight py-4">
        ...
        <div class="card card-md">
          <div class="card-body">
            ...
            <form action="{{ route('sign-in.action')}}" method="POST" autocomplete="off" novalidate data-parsley-validate id="validate_form">
              @csrf
              <div class="mb-3">
                <label class="form-label">{{ __('Username or Email')}}</label>
                <input type="text" class="form-control" name="username":value="old('username')" placeholder="username or email"  autocomplete="off" required autofocus
              ...
              <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                  ...
                  <span class="input-group-text">
                    <a href="#" class="link-secondary" title="Show password" onclick="showPassword()" data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
