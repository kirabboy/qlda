                        ...
                        <div class="card">
                            <div class="card-header">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Quản lý báo cáo dự án</li>
                                </ul>
                            </div>
                            <div class="card">
                                <div class="card-header justify-content-between">
                                    <h2 class="mb-0">Quản lý báo cáo dự án</h2>
                                    <a href="{{ route('project.report.add') }}" class="btn btn-primary">
                                        <i class="bi bi-plus-circle"></i>&nbsp;Thêm báo cáo dự án
                                    </a>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                ...
                                                <div>Nếu bạn tiếp tục, bạn sẽ xóa dữ liệu ra khỏi dữ liệu hệ thống.</div>
                                            </div>
